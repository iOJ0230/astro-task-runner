...
class DummyAstroEventProvider : AstroEventService {
    ...
    private fun buildGeminids(
        ...
        val start =
            LocalDateTime.of(peakDate.minusDays(1), LocalTime.of(22, 0))
                .atZone(zoneId).toOffsetDateTime()
        val end =
            LocalDateTime.of(peakDate.plusDays(1), LocalTime.of(4, 0))
                .atZone(zoneId).toOffsetDateTime()
